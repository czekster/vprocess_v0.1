 ...
 * Description: class Logger implementation, saving a file for analysis
 *
 */
...
/**
 * Keeps one output file stream opened during all procedure, closes when it frees the memory
 */
Logger::Logger() {
